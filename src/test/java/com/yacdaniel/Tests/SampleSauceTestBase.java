...
import com.yacdaniel.Utils.SauceHelpers;
...
public class SampleSauceTestBase implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider  {
    ...
    public static Object[][] sauceBrowserDataProvider(Method testMethod) {
        return new Object[][]{
                new Object[]{"chrome", "48", "Windows 7"},
                ////new Object[]{"chrome", "48", "Linux"},
                //new Object[]{"firefox", "46", "Windows 7"},
                //new Object[]{"chrome", "48", "Linux"},
                new Object[]{"firefox", "46", "Windows 7"},
                //new Object[]{"chrome", "48", "OS X 10.9"},
                ////new Object[]{"firefox", "46", "OS X 10.9"},




        };//1124*768 size screen resolution
    }
    ...
    protected void createDriver(String browser, String version, String os, String methodName)
        ...
        webDriver.get().manage().timeouts().implicitlyWait(300, TimeUnit.SECONDS);
